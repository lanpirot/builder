...
function clean_up()
    ...
    Helper.reset_logs([Helper.log_switch_up Helper.log_compile Helper.log_copy_to_missing]);
end
...
function out = build_sub_info(name2subinfo)
    ...
    sub_diversity = num2cell(extractfield(name2subinfo, Helper.diversity));
    sub_num_contained_elements = num2cell(extractfield(name2subinfo, Helper.num_contained_elements));
    sub_info = [sub_identities; sub_interfaces; sub_is_root; sub_depths; subtree_depths; sub_diversity; sub_num_contained_elements];
    sub_info = cell2struct(sub_info, {Helper.identity, Helper.interface, Helper.is_root, Helper.sub_depth, Helper.subtree_depth, Helper.diversity, Helper.num_contained_elements});
    out = {};
